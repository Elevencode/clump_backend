...
class AppService extends ApplicationChannel {
  ...
  Controller get entryPoint =>
      Router()..route('posts/[:id]').link(() => AppTokenController())!.link(() => AppPostController(managedContext));

  PostgreSQLPersistentStore _initDatabase() {
    return PostgreSQLPersistentStore(
        AppEnv.dbUsername, AppEnv.dbPassword, AppEnv.dbHost, AppEnv.dbPort, AppEnv.dpDatabaseName);
  }
}
